...
function cycleHeroColors() {
    ...
    const colors = [
        { c1: 'rgba(60, 139, 170, 0.25)', c2: 'rgba(117, 135, 147, 0.25)', text: ['#3c8baa', '#758793'] },
        { c1: 'rgba(117, 135, 147, 0.25)', c2: 'rgba(255, 255, 255, 0.15)', text: ['#758793', '#ffffff'] },
        { c1: 'rgba(255, 255, 255, 0.15)', c2: 'rgba(60, 139, 170, 0.25)', text: ['#ffffff', '#3c8baa'] }
    ];
